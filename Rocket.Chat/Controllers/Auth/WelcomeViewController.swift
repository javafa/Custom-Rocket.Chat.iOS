...
//                if let newViewController = storyBoard.instantiateViewController(withIdentifier: "ConnectServerViewController") as? ConnectServerViewController {
//                    self.present(newViewController, animated: true, completion: nil)
//                }
                self.performSegue(withIdentifier: "ConnectServer", sender: self)
            }
        }
